    ...
    <div className="home-container">
      ...
      <div className="job-info-wrapper">
        <div className="job-info info">
          <div className="info-boxes-container">
            ...
            {userSession && userSession.role === "Demandeur" ? (
              <div className="editButton">
                <Button
                  onClick={() => handleOpenCv(jobDetails.idOffre)}
                  variant="contained"
                >
                  Apply
                </Button>
        ...
        >
          ...
          <UpdateForm idOffer={jobId} handleCloseDialog={handleCloseDialog} />
        </Dialog>
      </div>
      {userSession && userSession.role === "Employeur" && (
        <div className="job-info-wrapper">
          <ApplicantsInfo idOffre={jobDetails.idOffre} />
        </div>
      )}
    </div>
  );
